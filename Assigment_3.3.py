...
#0.0 and 1.0. If the score is out of range, print an error.
...
#Check the input correct or not, if correct then continue to
#if function, else print "Wrong Input chief" and quit
try:
	sc = float(score)
except :
